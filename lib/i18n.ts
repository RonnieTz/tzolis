...
const resources = {
  en: {
    translation: {
      ...
      home: {
        title: 'Tzolis Welding & Metal Fabrication',
        subtitle: 'Professional Welding Services in Greece',
        description:
  ...
  gr: {
    translation: {
      ...
      home: {
        title: 'Τζολής Συγκόλληση & Κατασκευές Μετάλλου',
        subtitle: 'Επαγγελματικές Υπηρεσίες Συγκόλλησης στην Ελλάδα',
        description:
      ...
      about: {
        ...
        description:
          'Είμαστε μια κορυφαία εταιρεία συγκόλλησης και κατασκευών μετάλλου στην Ελλάδα με πάνω από 20 χρόνια εμπειρίας.',
        ...
        featuresDescriptions: {
          structural:
            'Υψηλής ποιότητας δομική συγκόλληση για κατασκευαστικά έργα',
        ...
        commitment: {
          ...
          customer: {
            ...
            description:
              'Συνεργαζόμαστε στενά με τους πελάτες μας για να παραδώσουμε προσαρμοσμένες λύσεις που καλύπτουν τις συγκεκριμένες τους ανάγκες.',
          },
        },
        whyChoose: {
          title: 'Γιατί να Επιλέξετε την Τζολής Συγκόλληση;',
          points: {
